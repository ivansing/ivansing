...
- **Languages:** TypeScript, JavaScript, Python, Node.js, Java (foundational — UBC MicroMasters)
- **Frontend:** Next.js (App Router), React, Tailwind CSS, shadcn/ui
- **Backend:** Next.js API Routes, Express.js, FastAPI
- **Databases:** PostgreSQL (Supabase), Firebase Firestore, MongoDB
- **Auth & Security:** Supabase Auth, JWT sessions, OAuth2 (PKCE), Row Level Security, role-based access control
- **Payments:** Stripe (subscriptions, webhooks, customer portal, usage tracking)
- **APIs:** RESTful API design, Zod validation, OpenAI API, SendGrid, Twilio
- **Deployment:** Vercel, Firebase, Google Cloud Platform, AWS (S3, EC2, Lambda, Elasticsearch)
- **DevOps:** Git, GitHub (feature branch workflow + CI), Docker, WSL2 Ubuntu
- **Testing:** Jest, pytest, Postman automation scripts
- **AI Workflow:** Claude Code, Claude Desktop with MCP integration
...
### SEO Assistant — Chrome Extension (Published)
Chrome extension for real-time SEO page analysis built with JavaScript and Manifest V3. Published on the Chrome Web Store.
...
I've been writing about what I learn too — articles on dev.to covering graph-based data structures, OOP patterns, and development tools. Teaching is how I make sure I actually understand something.
